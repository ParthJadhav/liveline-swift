...
| `candle-mode-controls` | 1.110% | 0.293 | 4.071 |
...
- Reduce the remaining text/grid halo differences, mostly from SwiftUI text rasterization versus canvas text drawing.
- Deepen candle-mode reveal/morph behavior to match the upstream OHLC collapse and candle-width transition paths.
